...
# todo 修改为你的数据的根目录
FILE_ROOT = "C:/Users/Scm97/Desktop/"
...
DEST_PPP = FILE_ROOT + "target_yolo_format"
DEST_IMAGES_PATH = "target_yolo_format/images"  # 区分训练集、测试集、验证集的图片目标路径
DEST_LABELS_PATH = "target_yolo_format/labels"  # 区分训练集、测试集、验证集的标签文件目标路径
