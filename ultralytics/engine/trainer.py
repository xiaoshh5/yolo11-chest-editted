...
class BaseTrainer:
    ...
    def _setup_train(self, world_size):
        ...
        if self.amp and RANK in {-1, 0} and self.device.type != "xpu":
    ...
    def _get_memory(self):
        ...
        elif self.device.type == "xpu" and hasattr(torch, "xpu") and hasattr(torch.xpu, "memory_reserved"):
    ...
    def _clear_memory(self):
        ...
        elif self.device.type == "xpu" and hasattr(torch, "xpu") and hasattr(torch.xpu, "empty_cache"):
    ...
    def read_results_csv(self):
        """Read results.csv into a dict, pandas optional."""
        try:
            import pandas as pd
            ...
            with open(self.csv, newline="") as f:
                ...
                for row in reader:
                    for k, v in row.items():
                        out.setdefault(k, []).append(float(v) if v.replace(".", "", 1).isdigit() else v)
                return out
